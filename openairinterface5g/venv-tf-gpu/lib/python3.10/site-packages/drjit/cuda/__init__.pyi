...
def register_gl_buffer(gl_buffer: int) -> typing_extensions.CapsuleType:
    """
...
def register_gl_texture(gl_texture: int) -> typing_extensions.CapsuleType:
    """
...
def unregister_cuda_resource(cuda_resource: typing_extensions.CapsuleType) -> None:
    """
...
def map_graphics_resource_ptr(cuda_resource: typing_extensions.CapsuleType) -> tuple[int, int]:
    """
...
def map_graphics_resource_array(cuda_resource: typing_extensions.CapsuleType, mip_level: int = 0) -> int:
    """
...
def unmap_graphics_resource(cuda_resource: typing_extensions.CapsuleType) -> None:
    """
